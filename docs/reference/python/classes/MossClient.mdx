...
- **docs** (List[[`DocumentInfo`](../interfaces/DocumentInfo)]): Documents to ingest into the index.
...
- **docs** (List[[`DocumentInfo`](../interfaces/DocumentInfo)]): Documents to add or upsert.
- **options** (Optional[[`AddDocumentsOptions`](../interfaces/AddDocumentsOptions)]): Upsert behavior overrides.
...
- **index_name** (`str`): Target index name.
- **options** (Optional[[`GetDocumentsOptions`](../interfaces/GetDocumentsOptions)]): Retrieval filters.
...
- **options** (Optional[[`QueryOptions`](../interfaces/QueryOptions)]): Controls custom embeddings and per-query overrides.
