...
| `docs` | [`DocumentInfo`](../interfaces/DocumentInfo)[] | Initial documents to add to the index. |
...
| `options?` | [`AddDocumentsOptions`](../interfaces/AddDocumentsOptions) | Optional configuration for the operation. |
