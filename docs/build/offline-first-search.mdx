...
- An index to query (create `faqs` via the [Quickstart](/start/quickstart) if you don’t have one yet)
...
Ensure the index exists (see [Quickstart](__/start/quickstart__) to create `faqs`).
</Step>
