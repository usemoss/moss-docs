...
Integrate the Moss Semantic Search SDK directly into a LiveKit Voice Agent. This setup allows your voice AI to perform ultra-low latency searches over your custom data to answer user questions in real-time.

## Why Use Moss with LiveKit?

### Ultra-Low Latency

Voice agents need responses in milliseconds. Moss delivers sub-10ms retrieval, ensuring your agents respond naturally without noticeable delays.
...
## 3. Creating the Knowledge Base with Moss
